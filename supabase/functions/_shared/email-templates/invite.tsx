...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="no" dir="ltr">
    <Head />
    <Preview>Du er invitert til Snakk</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>Du er invitert!</Heading>
          <Text style={text}>
            Du har blitt invitert til{' '}
            <Link href={siteUrl} style={link}><strong>Snakk</strong></Link>.
            Klikk på knappen under for å godta invitasjonen og opprette kontoen din.
          </Text>
