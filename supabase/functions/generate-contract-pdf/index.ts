...
/** Kontraktsmaler per tjeneste. Legg til ny nøkkel her for flere tjenester. */
export const KONTRAKT_TYPER = ["telefon", "moeter"] as const;
type KontraktType = (typeof KONTRAKT_TYPER)[number];
...
interface KontraktMal {
  tittel: string;
  kapasitetLabel: string;
  kolonneInkludert: string;
  formaal: string;
  tjenesten: string;
  pakker: PakkeRad[];
...
const MALER: Record<KontraktType, KontraktMal> = {
  telefon: {
    tittel: "Avtale om bruk av Snakk Teknologi AS",
    kapasitetLabel: "Inkluderte ringeminutter",
    kolonneInkludert: "Minutter",
    formaal:
      "Denne avtalen regulerer levering og bruk av Snakk sin AI-drevne telefonassistent og tilhørende tjenester. Tjenesten gir kunden tilgang til en intelligent telefonsvarer som håndterer innkommende og utgående samtaler.",
    tjenesten:
      "Snakk leverer en AI-basert telefonassistent som kan svare på spørsmål, ta imot bestillinger, booke møter og utføre andre oppgaver over telefon på vegne av kunden. Tjenesten inkluderer oppsett, konfigurasjon og løpende drift.",
    pakker: [
      { navn: "Telefon Basis", pris: 990, inkludert: "100 min" },
      { navn: "Telefon Start", pris: 2490, inkludert: "500 min" },
      { navn: "Telefon Pro", pris: 3990, inkludert: "1 000 min" },
      { navn: "Telefon Pluss", pris: 7490, inkludert: "2 000 min" },
      { navn: "Telefon Volum", pris: 13990, inkludert: "4 000 min" },
    ],
    ekstraSeksjoner: [],
  },
  moeter: {
    tittel: "Avtale om bruk av Snakk Møter og transkribering",
    kapasitetLabel: "Inkludert kapasitet",
    kolonneInkludert: "Inkludert",
    formaal:
    ...
    ekstraSeksjoner: [
      {
        tittel: "Møteplattform og kalender",
        punkter: [
          "Google Meet med Google-kalender er verifisert i bruk",
          "Microsoft Teams, Zoom og Microsoft 365-kalender avklares og testes i kundens oppsett før leveransen bekreftes",
          "Kunden velger regel for hvilke møter møteboten skal delta i, for eksempel kun eksterne møter",
          "Møteboten deltar ikke aktivt i samtalen; den tar opptak og lager innhold etter møtet",
        ],
      },
      {
        tittel: "Opptak, lagring og deltakerinformasjon",
        punkter: [
          "Standard lagringstid: 30 dager for opptak og 12 måneder for referat og transkripsjon",
          "Kunden er ansvarlig for å informere møtedeltakere om at møtet tas opp, og for å slippe møteboten inn i møter med venterom",
          "Alle medlemmer i kundens Snakk-konto har tilgang til møtene; egen privat møtevisning per ansatt er ikke inkludert",
          "Referat, oppgaver og AI-svar er hjelpemidler og bør kontrolleres av kunden før de brukes videre",
        ],
      },
      {
